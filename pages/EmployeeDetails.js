...
import Header from './Header'; // Assuming Header.js is in the same directory as EmployeeDetails.js
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <Button title="GET BACK TO ALL EMPLOYEES" onPress={() => console.log("Navigate back to all employees")} />
      </View>
    </ScrollView>
  );
};
